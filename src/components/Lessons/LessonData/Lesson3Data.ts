...
export const Lesson3Data = [
    ...
    },
    {
        ...
        code:`
        // The following function takes in two integers and returns their sum:

        int add(int a, int b) { // int a and int b are parameters
            return a + b; // This is what the function does each time it is called
        }
        
        int main() {
            // calling the function
            int sum = add(5, 7); // '5' and '7' are arguments. Note that we are setting the function to a variable!

            cout << "The sum is: " << sum << endl; // printing the function to the screen
    ...
    },
    {
        SlideNumber: 4,
        SlideTitle: "{",
        disc: `**{** <br> This is the opening brace for the main function. Everything between this brace and its corresponding closing brace is the body of the main function. All the code that the program executes will be inside these braces.`,
        code:`
        #include <iostream>
    ...
    },
    {
        SlideNumber: 7,
        SlideTitle: ";",
        disc: `**;** <br> In C++, the semicolon is a statement terminator. That means it marks the end of one logical statement. Here, it signifies the end of the output statement which prints "Hello, World!" to the standard output.`,
        code:`
        #include <iostream>
