...
export const Lesson7Data = [
    ...
    },
    {
        ...
        int main() {
            ...
            cout << "Address of x: " << &x << endl; // Outputs: Address of x: 0x7ffcc89ae8ac (Note: This value will vary)
            cout << "Value of ptr: " << ptr << endl; // Outputs: Value of ptr: 0x7ffcc89ae8ac
            cout << "Value of *ptr: " << *ptr << endl; // Outputs: Value of *ptr: 10
    ...
    },
    {
        ...
        int main() {
            ...
            // Print car details
            cout << carObj.brand << " " << carObj.model << " " << carObj.year << endl;  // Outputs: Toyota Corolla 2020
    ...
    },
    {
        ...
        int main() {
            ...
            try {
                ...
                cout << "Exception: " << e << endl;  // Catch and handle the error
            }
    ...
    },
    {
        ...
        int main() {
            ...
            std::string line;
            std::ifstream myfile2("example.txt"); // Open the file for reading
            if (myfile2.is_open()) {
