...
const LogIn = (): ReactElement => {
    ...
    const sendToSignUpPage = (): void => {
        navigate("/signUp")
    }

    return (
        <Container>
            <p>(This is a simulated log in page. Do not use a serious password, or any password that you have used in real websites. This is just an )</p>
