...
describe("<ScoresTemplate />", () => {
    ...
    const mockUserContext = {
        userData: {
            username: "test",
            lessonsCompleted: { lesson1: "yes", lesson2: "no" } as Record<
                string,
                "yes" | "no"
            >,
            quizScores: { quiz1: 1 },
            projectsCompleted: { project1: "yes", project2: "no" } as Record<
                string,
                "yes" | "no"
            >,
        },
    ...
    test("renders without crashing", () => {
        render(
            <MemoryRouter
                initialEntries={[
                    { pathname: "/scores/1", state: { totalScore: 8 } },
                ]}
            >
