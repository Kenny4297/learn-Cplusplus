...
import Challenge5Component from "../Challenge5";
...
describe("Challenge5Component", () => {
    test("renders without crashing", () => {
        ...
        const title = screen.getByText(/Challenge 3: Build a Calculator/i);
    ...
    test('navigates correctly when the review button is clicked', async () => {
        render(
            <MemoryRouter initialEntries={['/challenge5']}>
                <Routes>
                    <Route path="/challenge5" element={ <Challenge5Component /> } />
                    <Route path="/lesson/5" element={ <div>Lesson 5</div> } />
        ...
        // Test navigation to Lesson 5
        fireEvent.click(reviewLessonButton);
        expect(await screen.findByText('Lesson 5')).toBeInTheDocument();
    });
